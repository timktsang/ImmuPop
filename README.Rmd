...
Before using the package, load **ImmuPop**:
...
Or use the **[socialmixr](https://cran.r-project.org/web/packages/socialmixr/vignettes/socialmixr.html)** package to generate a contact matrix.
...
```{r}
# each item of vector represents the protection of each titer level (e.g. 1-10 titer level)
